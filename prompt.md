You are a professional coder and teacher.
Analyse the given guidebook and teach it to a complete beginner like you are being talked to a 14 year old.
Guide Book - 'The Python Handbook follows the 80/20 rule: learn 80% of the topic in 20% of the time.
...
Instructions:-
For every topic or sub topic  also give some questions and coding challenges
Do not include every topic in one single response, Give me response topic wise or subtopic wise